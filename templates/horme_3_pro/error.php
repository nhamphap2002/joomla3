...
<html lang="<?php echo $this->language; ?>" dir="<?php echo $this->direction; ?>">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo $tpath . $css ;?>" type="text/css" />
		<link rel="stylesheet" href="<?php echo $tpath ;?>/css/template.css" type="text/css" />
    <?php if ( $style != 'none') : ?>
    <link rel="stylesheet" href="<?php echo $tpath ;?>/css/<?php echo $style ?>.css" type="text/css" />
    <?php endif; ?>

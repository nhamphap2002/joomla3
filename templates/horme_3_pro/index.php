...
require_once JPATH_THEMES.'/'.$this->template.'/customizer.php'; // load customizer.php
?>
<!DOCTYPE html>
<html lang="<?php echo $this->language; ?>" dir="<?php echo $this->direction; ?>" >
  ...
  <body id="body" class="<?php echo $pageclass . ' ' . $bodyclass ; ?>">
    <div id="frame" class="<?php echo $framed ; ?>">
      <!--[if lte IE 8]>
      ...
      <![endif]-->
      <?php if ($this->countModules('vmtoolbar')) : ?>
      <!-- VMToolbar -->
      <div id="fds-vmtoolbar">
        <div class="<?php echo $container; ?>">
          <div class="<?php echo $bsrow; ?> vmtoolbar">
            <jdoc:include type="modules" name="vmtoolbar" style="none" />
          </div>
        </div>
      </div>
      <?php endif; ?>
      ...
      <header id="fds-header">
        <div class="<?php echo $container; ?> ">
          <div class="<?php echo $bsrow; ?>">
            ...
            <div class="col-sm-<?php echo $logosize; ?> fds-logo <?php if ($logosize == '12') echo 'text-center'; ?>" data-mh="header">
              <a href="<?php echo JURI::base(); ?>">
                <?php echo $logo; ?>
              </a>
            </div>

            <div class="col-sm-<?php echo $searchsize; ?> search" data-mh="header">
            ...
            <div class="col-sm-<?php echo $cartsize; ?> cart text-right" data-mh="header">
      ...
      <nav class="navbar navbar-default <?php if ($this->params->get('sticky'))  echo 'sticky'; ?>">
        <div class="container">
      ...
      if ($mobilehide && $this->params->get('fdsslider')) { // Mobile Detect ?>
      <?php } else { ?>
    ...
    <script>
      jQuery('#offcanvas').find('ul.nav').children('li.parent').children('a').prepend('<button class="btn btn-link btn-xs open-submenu"><span class="glyphicon glyphicon-plus"></span></button>');
      jQuery('button.open-submenu').click(function(e){
        var button = jQuery(this);
        var buttons = jQuery('button.open-submenu');
        e.preventDefault();
        buttons.children('span').removeClass('glyphicon-minus').addClass('glyphicon-plus');
        button.children('span').toggleClass('glyphicon-plus glyphicon-minus');
        button.parent().siblings('ul').slideToggle();
        button.parents('li').siblings('li.parent').children('ul').slideUp();
      });

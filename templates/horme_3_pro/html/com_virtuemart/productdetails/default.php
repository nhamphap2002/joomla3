...
if (!$tmpl) {
  ...
  <meta property="og:title" content="'.$this->product->product_name.'" />
  <meta property="og:description" content="'.JHtml::_('string.truncate', strip_tags($this->product->product_desc), 200).'" />

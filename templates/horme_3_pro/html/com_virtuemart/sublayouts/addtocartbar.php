	...
	if (($stockhandle == 'disableit' or $stockhandle == 'disableadd') and ($product->product_in_stock - $product->product_ordered) < 1) { ?>
        ...
        <div class="quantity-controls js-recalculate input-group margin-top-15">
          ...
          if($product->orderable) {
            ...
            echo '<button type="button" name="addtocart" class="addtocart-button-disabled btn btn-block disabled" title="'.vmText::_( 'COM_VIRTUEMART_ADDTOCART_CHOOSE_VARIANT' ).'">'. vmText::_( 'COM_VIRTUEMART_ADDTOCART_CHOOSE_VARIANT' ) .'</button>';
          }
        ?>
				</div> <?php
			} ?>

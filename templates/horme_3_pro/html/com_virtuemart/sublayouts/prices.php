...
<div class="product-price" id="productPrice<?php echo $product->virtuemart_product_id ?>">
    ...
    if ($product->prices['basePriceWithTax'] == '0' and $product->prices['discountAmount'] != 0) {
      echo '<div class="old-price">' . $currency->createPriceDiv ('basePrice', 'COM_VIRTUEMART_PRODUCT_BASEPRICE', $product->prices) . '</div>';
    } else {

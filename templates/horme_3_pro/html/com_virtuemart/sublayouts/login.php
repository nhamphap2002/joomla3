...
<div class="well collapse" id="vm-login">
  <form id="com-form-login" class="form-inline form-validate" action="<?php echo $url; ?>" method="post" name="com-login" >
...
<form class="well" action="<?php echo JRoute::_('index.php'); ?>" method="post" name="login" id="form-login">

...
<div id="cart-view" class="cart-view">
    ...
    <div class="payments-signin-button"></div>
		...
		<div class="checkoutStep alert alert-info" id="checkoutStep4"><?php echo vmText::_ ('COM_VIRTUEMART_USER_FORM_CART_STEP4'); ?></div>
		<?php } ?>
...
jQuery('.vm-shipment-row button[data-dynamic-update="1"], .vm-payment-row button[data-dynamic-update="1"]').parent('div').hide();

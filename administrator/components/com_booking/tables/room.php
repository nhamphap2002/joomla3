...
class BookingTableroom extends JTable
{
	...
	{
		JObserverMapper::addObserverClassToClass('JTableObserverContenthistory', 'BookingTableroom', array('typeAlias' => 'com_booking.room'));
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!JFactory::getUser()->authorise('core.admin', 'com_booking.room.' . $array['id']))
		{
			$actions         = JAccess::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_booking/access.xml',
				"/access/section[@name='room']/"
			);
			$default_actions = JAccess::getAssetRules('com_booking.room.' . $array['id'])->getData();
			$array_jaccess   = array();

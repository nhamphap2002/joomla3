...
class BookingModelRoom extends JModelAdmin
{
	 ...
	 * @since    1.6
	 */
	protected $text_prefix = 'COM_BOOKING';

	/**
	 * @var   	string  	Alias to manage history control
	 * @since   3.2
	 */
	public $typeAlias = 'com_booking.room';
	...
	public function duplicate(&$pks)
	{
		...
		// Access checks.
		if (!$user->authorise('core.create', 'com_booking'))
		{
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id))
		{
			...
			{
				$db = JFactory::getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__booking_room');
				$max             = $db->loadResult();

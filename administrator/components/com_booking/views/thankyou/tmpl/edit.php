...
<form
	...
	method="post" enctype="multipart/form-data" name="adminForm" id="thankyou-form" class="form-validate">

	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_BOOKING_TITLE_THANKYOU', true)); ?>
		<div class="row-fluid">

 ...
 * @since  1.6
 */
class BookingViewThankyou extends JViewLegacy
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_BOOKING_TITLE_THANKYOU'), 'thankyou.png');

		// If not checked out, can save the item.
		if (!$checkedOut && ($canDo->get('core.edit') || ($canDo->get('core.create'))))
		{
			JToolBarHelper::apply('thankyou.apply', 'JTOOLBAR_APPLY');
			JToolBarHelper::save('thankyou.save', 'JTOOLBAR_SAVE');
		}
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_booking.thankyou', $this->item->id);
		}

		if (empty($this->item->id))
		{
			JToolBarHelper::cancel('thankyou.cancel', 'JTOOLBAR_CANCEL');
		}
		else
		{
